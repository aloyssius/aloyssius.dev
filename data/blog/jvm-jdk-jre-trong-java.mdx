...
images:
  - /static/images/su-khac-nhau-giua-jvm-jdk-jre-trong-java-main.png
---
...
![](/static/images/jvm-jdk-jre-trong-java.png)

## Kiến trúc JVM (tự tìm hiểu)
![](/static/images/jvm-jdk-jre-trong-java-5.png)
...
![550x350](/static/images/jvm-jdk-jre-trong-java-3.png)
...
![](/static/images/jvm-jdk-jre-trong-java-1.png)
...
![](/static/images/jvm-jdk-jre-trong-java-6.png)
